# Session Brief — nonzero · Condition D: Plan, LSP
...
- Keep a log of all LSP tool calls in `lean_lsp_log_nonzero.md`
...
- Keep a running log of every LSP tool call (tool name, purpose, result) in
  `experiments/nonzero/plan_with_lsp/lean_lsp_log_nonzero.md`.

Save each milestone to its own file:
`experiments/nonzero/plan_with_lsp/output.milestone1.lean`
`experiments/nonzero/plan_with_lsp/output.milestone2.lean`
… and so on.
...
[paste the full contents of experiments/nonzero/nonzero.plan.md]
