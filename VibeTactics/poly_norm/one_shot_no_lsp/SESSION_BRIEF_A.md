# Session Brief — poly_norm · Condition A: No Plan, No LSP

**Tactic**: `poly_norm`
**Condition**: No milestone plan; no LSP tools.
...
`experiments/poly_norm/one_shot_no_lsp/output.lean`
...
Also save `output.lean` (even if it does not compile fully).
