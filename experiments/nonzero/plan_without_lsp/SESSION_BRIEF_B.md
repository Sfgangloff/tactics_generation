# Session Brief — nonzero · Condition B: Plan, No LSP
...
`experiments/nonzero/plan_without_lsp/output.milestone1.lean`
`experiments/nonzero/plan_without_lsp/output.milestone2.lean`
… and so on.
